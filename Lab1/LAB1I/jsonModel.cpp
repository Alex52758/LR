...
QJsonArray JsonModel::readJson(QString key) {
...
void JsonModel::writeRowToJSON(JsonModel::Row row) {
  QJsonObject obj;
...
JsonModel::Row JsonModel::getRow(int index) {
...
JsonModel::Row JsonModel::encrypt(JsonModel::Row row) {
...
JsonModel::Row JsonModel::decrypt(JsonModel::Row row) {
  auto login = row.login;
