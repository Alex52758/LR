...
0xb4,0x5,0x0,0x0,0x63,0x36,0x34,0x32,
...
0x0,0x0,0x0,0x0,0x86,0xb8,0xcb,0x18,
0x1,0xf1,0x15,0xcb,0x48,0x1b,0xf3,0xc0,
0x11,0x43,0xc8,0xf0,0x0,0x0,0x0,0x0,
0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
...
0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
0x6,0x0,0xd0,0x0,0x6,0x0,0x70,0x1,
...
aotContext->initGetEnumLookup(1, QMetaType::fromName("QQuickPopup*").metaObject(), "ClosePolicyFlag", "NoAutoClose");
if (aotContext->engine->hasError())
    return 0.0;
}
{
...
QObject *r2;
// generate_LoadQmlContextPropertyLookup
while (!aotContext->loadAttachedLookup(2, aotContext->qmlScopeObject, &r2)) {
aotContext->setInstructionPointer(2);
...
// generate_GetLookup
{
while (!aotContext->getObjectLookup(3, r2, &r2)) {
aotContext->setInstructionPointer(4);
aotContext->initGetObjectLookup(3, r2, QMetaType::fromName("QQuickOverlay*"));
if (aotContext->engine->hasError())
    return static_cast<QObject *>(nullptr);
}
}
