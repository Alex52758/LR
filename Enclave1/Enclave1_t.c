...
static sgx_status_t SGX_CDECL sgx_getElementByIndex(void* pms)
{
	...
	ms_getElementByIndex_t __in_ms;
	if (memcpy_s(&__in_ms, sizeof(ms_getElementByIndex_t), ms, sizeof(ms_getElementByIndex_t))) {
	...
	getElementByIndex(_in_buffer, _tmp_len, __in_ms.ms_index);
	if (_in_buffer) {
